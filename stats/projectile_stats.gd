...
## Optional: Number of bloons this projectile can hit before disappearing (pierce).
@export var pierce: int = 1
## If true, this projectile can damage Lead bloons.
@export var can_pop_lead: bool = false # Make sure this is uncommented and usable
...
func _init(p_speed: float = 15.0,
			...
			p_pierce: int = 1,
			p_can_pop_lead: bool = false, # Added parameter
	...
	lifetime = p_lifetime
	pierce = p_pierce
	can_pop_lead = p_can_pop_lead # Assign parameter
